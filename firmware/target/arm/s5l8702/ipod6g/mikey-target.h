 ...
 * mikey_button_read() returns the current button mask (BUTTON_RC_VOL_*
 * for volume, BUTTON_MULTIMEDIA_PLAYPAUSE for the center click,
 * BUTTON_NONE if nothing pressed) and is safe to call from the button
 * tick. */
